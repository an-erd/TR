...
const uint8_t	ledArrayAllEffect[ALL_LED__EFFECT_STEPS] = { 0x00, 0xFF, 0x00,
	0x00, 0x01, 0x03, 0x07, 0x0E, 0x1C, 0x38, 0x70, 0xE0, 0xC0, 0x80, 
	0x00, 0x80, 0xC0, 0xE0, 0x70, 0x38, 0x1C, 0x0E, 0x07, 0x03, 0x01, 0x00,};
	
				// effect from L->R->L for all PORTD (red/orange leds)
